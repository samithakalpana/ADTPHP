	...
	<section id="inner_intro" class="section-padding">
		<div class="container">
			<div class="inner_wp z_index white_text">
				<div class="row">
					<div class="col-md-12">
						<h1 class="text-center">Somawati Hewavitarne Trust & Simon Hewavitarne Trust</h1>
						<nav class="breadcrumb">
							<ul>
								<li class="breadcrumb-item"><a href="index.html">Home</a></li>
								<li class="breadcrumb-item active">Somawati Hewavitarne Trust & Simon Hewavitarne Trust</li>
							</ul>
						</nav>
					</div>
				</div>
				...
				<div class="col-xl-9 col-md-9">
					...
					<div class="about-us-content">
						<div class="section-header">
							<div class="align-left"><h2><u class="text-custom-primary">Somawati Hewavitarne Trust
</u></h2></div></div>  
...
<a href="shop_pages1.php" class="btn btn-sm float-left">Purchase the Tipitaka publications</a>
        </div>
	</div>
				</section>
	...
	<section class="section-padding" id="about-team">
		<div class="container">
			<div class="our_team">
				<div class="section-header-left text-left">
					<!-- <h3>Our Teachers</h3> -->
					<h3 class="align_left">The Simon Hewavitarne Board of Trustees are:</h3>
						...
						<div class="owl-carousel team-carousel">
							...
							<div class="item">
								<div class="box_wrap">
									...
									<p> Is a great grandnephew of Anagarika Dharmapala and great grandson of Edmund Hewavitarne and, Life Member Maha Bodhi Society of Sri Lanka He was the former Chairman and Managing Director of <i>H Don Carolis & Sons</i> .
</p>
