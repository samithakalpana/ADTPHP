			...
			<div class="inner_wp z_index white_text">
				<div class="row">
					<div class="col-md-12">
						...
						<h5 class="text-center">Mary Robinson Foster </h5>
						<nav class="breadcrumb">
							<ul>
								<li class="breadcrumb-item"><a href="index.php">Home</a></li>
								<li class="breadcrumb-item active">Mary Robinson Foster </li>
							</ul>
						</nav>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="sa-paster-about-area">
							...
							<a href="https://www.theosophical.org/about/about-the-society"><span style="color: blue;"><b>Theosophical Society</b></span></a> on May 12, 1882. Initially a member of the Golden Gate branch in San Francisco, she soon organized lectures and classes in Honolulu. She helped to organize the Aloha Branch in February 1894.
