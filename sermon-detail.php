...
<!-- Mirrored from primehostingindia.com/templatemonster/html/templezen/sermon-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 18:04:36 GMT -->
<head>
...
<body id="tl">
	...
	<section id="inner_intro" class="section-padding">
		<div class="container">
			<div class="inner_wp z_index white_text">
				<div class="row">
					<div class="col-md-12">
						<h1 class="text-center">Sermon Detail</h1>
						<nav class="breadcrumb">
							<ul>
								<li class="breadcrumb-item"><a href="index.html">Home</a></li>
								<li class="breadcrumb-item"><a href="sermon.html">Sermon</a></li>
								<li class="breadcrumb-item active">Sermon Detail</li>
							</ul>
						</nav>
					</div>
				</div>
	...
	<section class="post_detail section-padding">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h4>It is no use lying to one's self</h4>
					...
					<div class="post_img">
						<img src="assets/images/sermon/sermon-detail-770x420.png" alt="image">
									...
									<div class="comment the-comment">
										...
										<div class="comment-content">
											<div class="comment-meta">
												<span class="comment-author"> <a href="#" class="url">laxmi kant</a></span> <span class="comment-time"> 15 May, 2020</span>
											</div>
											<div class="text">
									...
									<ol>
										<li class="comment">
											<div class="comment the-comment">
												...
												<div class="comment-content">
													<div class="comment-meta">
														<span class="comment-author"> <a href="#" class="url">pitambar</a></span> <span class="comment-time"> 02 Sep, 2020</span>
													</div>
													<div class="text">
														<div class="comment-text">
															<p>That far ground rat pure from newt far panther crane lorikeet overlay alas cobra across much
						...
						<div class="sidebar_widgets p-0">
							<div class="popular_sermon">
								...
								<div class="sermons_list">
									<h6><a href="#">Detached action is unselfish work.</a></h6>
									<ul class="sermons_meta">
										<li><i class="fa fa-user"></i> Message from <a href="#">yogbhagat</a></li>
								...
								<div class="sermons_list">
									<h6><a href="#">action is better than inaction</a></h6>
									<ul class="sermons_meta">
										<li><i class="fa fa-user"></i> Message from <a href="#">yogbhagat</a></li>
								...
								<div class="sermons_list">
									<h6><a href="#">one who has faith,has peace</a></h6>
									<ul class="sermons_meta">
										<li><i class="fa fa-user"></i> Message from <a href="#">yogbhagat</a></li>
										<li><i class="far fa-calendar-alt"></i> sep 03, 2020</li>
									</ul>
								...
								<div class="sermons_list">
									<h6><a href="#">Man is made by his belief</a></h6>
									<ul class="sermons_meta">
										<li><i class="fa fa-user"></i> Message from <a href="#">yogbhagat</a></li>
										<li><i class="far fa-calendar-alt"></i> sep 03, 2020</li>
									</ul>
...
<!-- Mirrored from primehostingindia.com/templatemonster/html/templezen/sermon-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 18:05:08 GMT -->
</html>
