...
<body id="tl">
	...
	<section id="inner_intro" class="section-padding">
		<div class="container">
			<div class="inner_wp z_index white_text">
				<div class="row">
					<div class="col-md-12">
						<h1 class="text-center">shop-full-width</h1>
	...
	<section class="section-padding tl-shop-section">
		...
		<div class="col-md-12">
		 ...
		 <div class="row">
				...
				<div class="tl-img-shop">
							...
							<img src="assets/images/shop/10.png" alt="image" class ="mx-auto image-fluid d-block">
						</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				...
				<div class="img-shop-wrapper tl-shop-single">
			<div class="tl-img-shop">
						<img src="assets/images/shop/11.png" alt="image" class ="mx-auto image-fluid d-block">
					</div>
					<div class="tl-product-content">
							<h4>Product Name</h4>
							<p>$56.25 <span class="off-price">$56</span></p>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				...
				<div class="img-shop-wrapper tl-shop-single">
			<div class="tl-img-shop">
						<img src="assets/images/shop/12.png" alt="image" class ="mx-auto image-fluid d-block">
					</div>
					<div class="tl-product-content">
							<h4>Product Name</h4>
							<p>$56.25 <span class="off-price">$56</span></p>
			...
			<div class="tl-img-shop">
						...
						<img src="assets/images/shop/13.png" alt="image" class ="mx-auto image-fluid d-block">
					</div>
					<div class="tl-product-content">
							<h4>Product Name</h4>
							<p>$56.25 <span class="off-price">$56</span></p>
		...
		<div class="col-lg-4 col-md-6 col-sm-6">
			...
			<div class="img-shop-wrapper tl-shop-single">
		<div class="tl-img-shop">
					<img src="assets/images/shop/14.png" alt="image" class ="mx-auto image-fluid d-block">
				</div>
				<div class="tl-product-content">
						<h4>Product Name</h4>
						<p>$56.25 <span class="off-price">$56</span></p>
		...
		<div class="col-lg-4 col-md-6 col-sm-6">
			...
			<div class="img-shop-wrapper tl-shop-single">
		<div class="tl-img-shop">
					<img src="assets/images/shop/5.png" alt="image" class ="mx-auto image-fluid d-block">
				</div>
				<div class="tl-product-content">
						<h4>Product Name</h4>
						<p>$56.25 <span class="off-price">$56</span></p>
			...
			<div class="tl-img-shop">
						...
						<img src="assets/images/shop/4.png" alt="image" class ="mx-auto image-fluid d-block">
					</div>
					<div class="tl-product-content">
							<h4>Product Name</h4>
							<p>$56.25 <span class="off-price">$56</span></p>
		...
		<div class="col-lg-4 col-md-6 col-sm-6">
			...
			<div class="img-shop-wrapper tl-shop-single">
		<div class="tl-img-shop">
					<img src="assets/images/shop/2.png" alt="image" class ="mx-auto image-fluid d-block">
				</div>
				<div class="tl-product-content">
						<h4>Product Name</h4>
						<p>$56.25 <span class="off-price">$56</span></p>
