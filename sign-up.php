            ...
            <div class="row">
              <div class="col-md-6 offset-col-6 mx-auto d-block login-page">
                <div class="login-page">
                    ...
                    <p class="sub_title">Already have an account? <a class="color-litegreen" href="log-in.html">Login here!</a></p>
                </div>
                <form class="login-form-t">
                  <div class="form-label-group">
                    <label for="inputName">Full Name</label>
                    <input type="email" id="inputName" class="form-control" placeholder="Your Full Name" required="">
                  </div>
                  ...
                  <button class="btn btn-lg btn-block tl-btn-round-2 text-uppercase font-weight-bold mb-2" type="submit">Register</button>
