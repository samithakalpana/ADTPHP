	...
	<section id="inner_intro" class="section-padding">
		<div class="container">
			<div class="inner_wp z_index white_text">
				<div class="row">
					<div class="col-md-12">
						<h1 class="text-center">අපගේ පිංතූර ගැලරිය<br/>
</h1>
						<nav class="breadcrumb">
							<ul>
								<li class="breadcrumb-item"><a href="sinhala_index.php">මුල් පිටුව</a></li>
								<li class="breadcrumb-item active">අපගේ පිංතූර ගැලරිය
							</ul>
						</nav>
					</div>
				</div>
	...
	<!-- /Donation-img section -->
		...
		<div class="container">
			...
			<div class="col-xl-12 col-lg-5 offset-xl-1 align-self-center">
					...
					<div class=" heading">
						<h3 class="align_center">අනගාරික ධර්මපාලයන්ගේ වටිනා සහ ඓතිහාසික පිංතූර ගැලරියක් සකස් කිරීම අප දැනටමත් අරඹා ඇත.ඉන් රූපරාමු කිහිපයක් පහතින් ඔබට දිස්වනු ඇත.</h3>
					</div>
				</div>
			</div>
