...
<head>
    ...
    <script src="//www.google.com/recaptcha/api.js?render=6LceXdwUAAAAAM624k2Zezhs-jnmdJE8hjmhRMBh"></script>
    ...
    <section id="inner_intro_without_image" class="section-padding">
        <div class="container">
            <div class="inner_wp z_index white_text">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center">ඇමතුම්</h1>
                        <nav class="breadcrumb">
                            <ul>
                                <li class="breadcrumb-item"><a href="index.php">මුල් ඵිටුව</a></li>
                                <li class="breadcrumb-item active">ඇමතුම්</li>
                            </ul>
                        </nav>
                    </div>
                </div>
